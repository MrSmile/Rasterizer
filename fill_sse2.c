// fill_sse2.c : low-level rasterization using SSE2
//
...
static __m128i index_x8[4];

void init_sse2_consts() // TODO: remove
{
    index_x8[0] = _mm_set_epi16( 7,  6,  5,  4,  3,  2,  1,  0);
    index_x8[1] = _mm_set_epi16(15, 14, 13, 12, 11, 10,  9,  8);
    index_x8[2] = _mm_set_epi16(23, 22, 21, 20, 19, 18, 17, 16);
    index_x8[3] = _mm_set_epi16(31, 30, 29, 28, 27, 26, 25, 24);
}
